...
public class GlideRoundTransform implements Transformation<Bitmap> {
     ...
     * @param rightBottom
     */
    public GlideRoundTransform(Context context, float radius, boolean leftTop, boolean leftBottom, boolean rightTop, boolean rightBottom) {
        this.mBitmapPool = Glide.get(context).getBitmapPool();
        this.radius = radius;
        this.exceptLeftTop = !leftTop;
        this.exceptLeftBottom = !leftBottom;
     ...
     * @param onlyTop 顶部是圆角
     */
    public GlideRoundTransform(Context context, float radius, boolean onlyTop) {
        this.mBitmapPool = Glide.get(context).getBitmapPool();
        this.radius = radius;
        this.exceptLeftTop = false;
        this.exceptRightTop = false;
        this.exceptLeftBottom = onlyTop;
        this.exceptRightBottom = onlyTop;
    }
