...
import com.by.lizhiyoupin.app.common.utils.OSUtils;
...
public class StatusBarUtils {
     ...
     * @param activity
     * @param color
     * @param statusBarAlpha  0透明 255不透明（设置的颜色）
     */
    public static void addTranslucentColorView(Activity activity, @ColorInt int color,@IntRange(from = 0, to = 255) int statusBarAlpha) {
        if (activity==null){
            return;
        }
        ...
        if (fakeTranslucentView != null) {
            ...
            fakeTranslucentView.setBackgroundColor(ColorUtils.setAlphaComponent(color,statusBarAlpha));
        } else {
     ...
     * @param color          状态栏颜色值
     * @param statusBarAlpha 状态栏透明度 0(正常颜色) 255黑
     */
    ...
    private static boolean setMIUISetStatusBarLightMode(Activity activity, boolean dark) {
        ...
        if (window != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && OSUtils.isMiUIV7OrAbove()) {
