...
/*    public static int checkPermissionReturnInt(Context context,String permission){
    ...
    public static boolean shouldStartApplication(Context appContext) {
        List<String> permissionList = PermissionsUtil.checkPermissions(appContext,
...
//        getAppDetailSettingIntent();
    ...
    public static boolean hasAppPermission(Context context) {
        return PermissionsUtil.checkPermission(context, Manifest.permission.READ_PHONE_STATE)
                && PermissionsUtil.checkPermission(context, Manifest.permission.READ_EXTERNAL_STORAGE)
                && PermissionsUtil.checkPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE);
    }
