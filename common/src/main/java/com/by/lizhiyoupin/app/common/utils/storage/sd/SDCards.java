...
public final class SDCards {
     ...
     * {@link Context#getCacheDir() Context.getCacheDir()} returns null).
     */
    public static File getStorageDir(Context context, String dirName, boolean preferExternal) {
        ...
        if (preferExternal && MEDIA_MOUNTED.equals(externalStorageState)
            ...
            appCacheDir = getExternalStorageDir(context, dirName);
        }
        if (appCacheDir == null) {
    ...
    public static File getCacheDir(Context context, String cacheDir) {
        File appCacheDir = getCacheDir(context);
     ...
     * @return Cache {@link File directory}
     */
    public static File getOwnCacheDir(Context context, String cacheDir) {
        File appCacheDir = null;
     ...
     * @return Cache {@link File directory}
     */
    public static File getOwnCacheDir(Context context, String cacheDir, boolean preferExternal) {
        File appCacheDir = null;
    ...
    private static File getExternalStorageDir(Context context, String dirName) {
