package com.by.lizhiyoupin.app.common.log;
...
public class LZLog {
    ...
    private static void log(int priority, String tag, String msg, Throwable tr) {
        LZLogManager.getInstance().log(priority, tag, msg, tr);
    }

    public static void init(final Context context) {
        LZLogManager.getInstance().init(context);
    }
    ...
    public static void setFileLogEnable(final boolean enable) {
        ...
        if (enable) {
            LZLogManager.getInstance().initFileThread();
        }
    }

    public static void release() {
        LZLogManager.getInstance().release();
    }

    private static final class LZLogManager implements Handler.Callback {
