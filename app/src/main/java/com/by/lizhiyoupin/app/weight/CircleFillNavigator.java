 ...
 * Summary: 圆圈式的指示器
 */
public class CircleFillNavigator extends View implements IPagerNavigator {
    private int mRadius;
    ...
    private boolean normalFill;
    private boolean mFollowTouch = true;    // 是否跟随手指滑动

    public CircleFillNavigator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void drawCircles(Canvas canvas) {
        mPaint.setStyle(normalFill ? Paint.Style.FILL : Paint.Style.STROKE);
    ...
    public void setNormalFill(boolean normalFill) {
