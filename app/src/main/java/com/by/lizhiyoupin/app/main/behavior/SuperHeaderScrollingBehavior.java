 ...
 * Summary:
 */
public class SuperHeaderScrollingBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    public static final String TAG= SuperHeaderScrollingBehavior.class.getCanonicalName();
    ...
    public SuperHeaderScrollingBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, LinearLayout child, View dependency) {
        //这里找出依赖视图的view
        if (dependency != null && dependency.getId() == R.id.super_header_cl) {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, LinearLayout child, View dependency) {
        ...
        final float progress = 1.f -
                Math.abs(dependency.getTranslationY() / (dependency.getHeight() -statusHeight));
    ...
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, LinearLayout child, View target, float velocityX, float velocityY) {
        ...
        return false/*onUserStopDragging(velocityY)*/;
    }
