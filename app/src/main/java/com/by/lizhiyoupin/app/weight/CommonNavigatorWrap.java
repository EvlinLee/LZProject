 ...
 * Summary: 包裹内容用的
 */
public class CommonNavigatorWrap extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public CommonNavigatorWrap(Context context) {
        super(context);
    ...
    private void init() {
        ...
        FrameLayout.LayoutParams layoutParams = (LayoutParams) mTitleContainer.getLayoutParams();
        //title 左右间隔10dp
        layoutParams.leftMargin=DeviceUtil.dip2px(getContext(),10);
        layoutParams.rightMargin=DeviceUtil.dip2px(getContext(),10);
    ...
    private void initTitlesAndIndicator() {
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v instanceof View) {
                ...
                if (mAdjustMode) {
                    ...
                    if (((View) v).getLayoutParams()!=null){
                        lp= (LinearLayout.LayoutParams) ((View) v).getLayoutParams();
                    }else {
        ...
        if (mAdapter != null) {
            ...
            if (mIndicator instanceof View) {
                LinearLayout.LayoutParams lp;
                if (((View) mIndicator).getLayoutParams()!=null){
                    lp= (LinearLayout.LayoutParams) ((View) mIndicator).getLayoutParams();
                }else {
                    lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
                }
