...
public class LimitedTimePageTitleView extends LinearLayout implements IPagerTitleView {
    ...
    private void init(Context context) {
        ...
        selectTipsColor = getResources().getColor(R.color.color_C8161D);
        selectTimeColor = Color.WHITE;
        unSelectTipsColor = getResources().getColor(R.color.white_80);
        unSelectTimeColor = getResources().getColor(R.color.white_80);
        setGravity(Gravity.CENTER);
        mTipTv.setTextSize(TypedValue.COMPLEX_UNIT_SP,tipsSizeSp);
        mTimeTv.setTextSize(TypedValue.COMPLEX_UNIT_SP,timeSizeSp);
        selectTipsBg=R.drawable.shape_bg_limited_time_title;
    }
