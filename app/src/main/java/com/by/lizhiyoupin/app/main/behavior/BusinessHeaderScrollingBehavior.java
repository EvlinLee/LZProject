 ...
 * Summary: 商学院 behavior
 */
public class BusinessHeaderScrollingBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    public static final String TAG= BusinessHeaderScrollingBehavior.class.getCanonicalName();
    ...
    public BusinessHeaderScrollingBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, LinearLayout child, View dependency) {
        //这里找出依赖视图的view
       /* if (dependency != null && dependency.getId() == R.id.business_header_ll) {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, LinearLayout child, View dependency) {
       ...
       /* Resources resources = getDependentView().getResources();
        final float progress = 1.f -
                Math.abs(dependency.getTranslationY() / (dependency.getHeight() -statusHeight- resources.getDimension(R.dimen.business_collapsed_header_height)));
