 ...
 * Summary: 本地服务器数据
 */
public class DiamondKongSortListAdapter extends CommonRecyclerViewAdapter {
    public static final int TYPE_SINGLE = 0;
    public static final int TYPE_OTHER = 1;
    public int type = TYPE_OTHER;

    public DiamondKongSortListAdapter(Context context) {
        super(context);
    }
    ...
    class ViewHolder extends CommonViewHolder {
        ...
        public void bindData(Object itemData) {
            ...
            HandPickDetailBean bean = (HandPickDetailBean) itemData;
            if (type == TYPE_OTHER) {
            ...
            ViewUtil.setTextViewFormat(mContext, mItemListVolumeTv, R.string.list_volume_text, StringUtils.getIVolume(bean.getVolume()));
        ...
        public void onItemClicked() {
            ...
            HandPickDetailBean bean = (HandPickDetailBean) getListData().get(mRealPosition);
            if (bean == null) {
                return;
            }
