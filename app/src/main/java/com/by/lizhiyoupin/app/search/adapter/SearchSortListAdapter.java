 ...
 * Summary: 三方 商品排序列表adapter
 */
public class SearchSortListAdapter extends CommonRecyclerViewAdapter {
    public static final int TYPE_SINGLE = 0;//单列
    public static final int TYPE_OTHER = 1;//多列
    public int type = TYPE_OTHER;

    public SearchSortListAdapter(Context context) {
        super(context);
    }
    ...
    class ViewHolder extends CommonViewHolder {
        ...
        public void bindData(Object itemData) {
            ...
            SearchCommodityBean bean = (SearchCommodityBean) itemData;
            if (type == TYPE_OTHER) {
        ...
        public void onItemClicked() {
            ...
            SearchCommodityBean bean = (SearchCommodityBean) getListData().get(mRealPosition);
            if (bean==null){
                return;
            }
