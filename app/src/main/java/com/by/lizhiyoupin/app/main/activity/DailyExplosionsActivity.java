...
import com.by.lizhiyoupin.app.main.adapter.DailyExplosionsAdapter;
 ...
 * jyx
 * */
@Route(path = "/app/DailyExplosionsActivity")
public class DailyExplosionsActivity extends BaseMVPActivity<MessageContract.MessageView,
    ...
    private DailyExplosionsAdapter adapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_explosions);
    ...
    private void initView() {
        ...
        adapater = new DailyExplosionsAdapter(this);
        ...
        mLoadMoreHelper = new LoadMoreBuilderRx<UserMessageVO, Integer>(this)
                ...
                .loader(new LoadMoreHelperRx.Loader<UserMessageVO, Integer>() {
                    ...
                    public Observable<? extends Collection<UserMessageVO>> load(Integer integer,
                                                                                int pageSize) {
                        return ApiService.getMessageApi().requestUserMessage(4, integer, pageSize).map(new Function<BaseBean<List<UserMessageVO>>, Collection<UserMessageVO>>() {
                            @Override
    ...
    private void reupdateStatus() {
        SettingRequestManager.requestMessageStatus("4", "0")
